...
-- Demonstrates: CEO wants yearly → quarterly → monthly sales view
...
-- Demonstrates: Identify top-performing products by revenue
...
-- Demonstrates: Segment customers by total spending
